                                ...
                                <div class="product product-area shop-grid-product-area clearfix">
                                    ...
                                    <ul>
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="{{route('productdetails',$product->product_slug)}}">{{Str::limit($product->short_desc,40)}} </a></p>
                                            <div class="rating">
                                ...
                                <div class="product_details_content">
                                    ...
                                    <div class="quantity_wrap">
                                        ...
                                        <div class="total_price">
                                            Total: ৳ {{($product->product_price)-($product->discount_price)}}
                                        </div>
                                    </div>
                                ...
                                <div class="product-area-row">
                                    ...
                                    <div class="grid clearfix">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="#">{{Str::limit($product->short_desc,40)}}</a></p>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
