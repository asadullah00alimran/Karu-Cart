                    ...
                    <div class="product-area clearfix">
                        ...
                        <div class="grid">
                            ...
                            <div class="details">
                                ...
                                <p><a href="{{route('productdetails',$product->product_slug)}}">{!!Str::limit($product->short_desc,30)!!}
                                    </a></p>
                                <div class="rating">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="product_details_content">
                                                            ...
                                                            <ul class="default_btns_group ul_li">
                                                                <li>
                                                                <p>
                                                                {!!Str::limit($product->short_desc,150) !!}
                                                            </p>
                                                                </li>
                                                            </ul>
                ...
                <div class="product-sidebar">
                    ...
                    <div class="widget product-add">
                        <div class="product-img">
                            <img src="{{ asset('frontend') }}/images/shop/product_img_10.jpg" alt>
                        </div>
                        <div class="details">
                            <h4>Clothing Craft</h4>
                            <p>Crafting For Global Purpose</p>
                    ...
                    <div class="widget audio-widget">
                        ...
                        <ul>
                            <li><a class="text-white">Things You Can Get Here</a></li>
                            <li><a class="text-white">Clothing Items</a></li>
                            <li><a class="text-white">Clay Arts</a></li>
                            <li><a class="text-white">Paper Arts</a></li>
                            <li><a class="text-white">Metal Arts</a></li>
                            <li><a class="text-white">Wooden Arts</a></li>
                            <li><a class="text-white">Jute Arts</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row promotion_banner_wrap">
            <div class="col col-lg-6">
                <div class="promotion_banner">
                    <div class="item_image">
                        <img src="{{ asset('frontend') }}/images/promotion/banner_img_1.jpg" alt>
                    </div>
                    <div class="item_content">
                        <h3 class="item_title">History Of Our  <span>Cloths.</span></h3>
                        <p>In the early 20th century, saris were delicate muslin or chiffon, 
                            beaded and embroidered lightly along the borders. Blouses were tailored in Edwardian style 
                            with lapels on the front and embroidered details on slightly puffed sleeves. This was the start
                             of Bengali fusion-wear</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col col-lg-6">
                <div class="promotion_banner">
                    <div class="item_image">
                        <img src="{{ asset('frontend') }}/images/promotion/banner_img_2.jpg" alt>
                    </div>
                    <div class="item_content">
                        <h3 class="item_title">History Of Our Folk  <span>Arts.</span></h3>
                        <p>
                        Proper evidence about the earliest development of Bangladeshi art refers to the Mauryan age. A number of sculptures have been discovered in Bangladesh which reflect the rich heritage of Mauryan art. The most significant 
                        Bangladeshi rule which existed from 750 to 1174 CE.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="deals_product_layout1">
                    <div class="bg_area">
                        ...
                        <p style="font-size:20px; font-weight:bold;">
                           10% Cashback If You Pay Via Nagad.
                        </p>
            ...
            <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                <div class="slider_item col">
                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_1.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Colthing Craft</h3>
                        </div>
                    </div>

                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_2.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Clat Craft</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="slider_item col">
                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_3.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Wooden Craft</h3>
                        </div>
                    </div>

                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_4.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Jute Craft</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="slider_item col">
                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_5.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Handmade Paining</h3>
                        </div>
                    </div>

                    <div class="viewed_product_item">
                        <div class="item_image">
                            <img src="{{ asset('frontend') }}/images/viewed_products/viewed_product_img_6.jpg"
                                alt="image_not_found">
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">Metal Crafting</h3>
                        </div>
                    </div>
                </div>
                <div class="slider_item col">
