...
<div class="br-pagebody">
    <div class="card">
        ...
        <h4>All Coupon <a class="btn btn-info btn-sm" href="{{ route('admin.coupon.create') }} " style="float: right;">Add Coupon</a></h4>
